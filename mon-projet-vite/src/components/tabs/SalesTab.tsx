...
export function SalesTab({ sales }: SalesTabProps) {
  ...
  return (
    <div className="animate-fadeIn">
      ...
      {/* Liste des ventes */}
      <div className="card">
        <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--dark-green)' }}>
          Dernières ventes
        </h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b" style={{ borderColor: '#E5E7EB' }}>
                  <th className="text-left py-2 px-3 text-sm font-semibold" style={{ color: 'var(--dark-green)' }}>
                    Date/Heure
                  </th>
                  <th className="text-left py-2 px-3 text-sm font-semibold" style={{ color: 'var(--dark-green)' }}>
                    Vendeuse
                  ...
                  <th className="text-right py-2 px-3 text-sm font-semibold" style={{ color: 'var(--dark-green)' }}>
                    Montant
                  </th>
                  <th className="text-center py-2 px-3 text-sm font-semibold" style={{ color: 'var(--dark-green)' }}>
                    Statut
                  </th>
                </tr>
              </thead>
              <tbody>
                {sales
                  ...
                  .slice(0, 20)
                  .map((sale, index) => (
                    <tr key={sale.id || index} className="border-b" style={{ borderColor: '#F3F4F6' }}>
                      ...
                      <td className="py-2 px-3 text-sm font-medium" style={{ color: 'var(--dark-green)' }}>
                        {sale.vendorName}
                      </td>
                      <td className="py-2 px-3 text-sm">
                      ...
                      <td className="py-2 px-3 text-sm text-right font-bold" style={{ color: 'var(--primary-green)' }}>
