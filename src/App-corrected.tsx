...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const savedCart = loadFromStorage<CartItem[]>(STORAGE_KEYS.CART, []);
    const savedSales = loadFromStorage<Sale[]>(STORAGE_KEYS.SALES, []);
    const savedVendor = loadFromStorage<Vendor | null>(STORAGE_KEYS.VENDOR, null);
