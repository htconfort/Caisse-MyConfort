...
echo "URL: https://n8n.myconfort.fr/webhook-test/sync/invoices"
echo ""
...
curl -X GET \
  ...
  "https://n8n.myconfort.fr/webhook-test/sync/invoices" \
...
curl -X POST \
  ...
  "https://n8n.myconfort.fr/webhook-test/sync/status-update" \
  -w "\n\nStatus Code: %{http_code}\n" \
  -s
...
echo "   1. Connectez-vous à N8N: https://n8n.myconfort.fr"
